...
export default function App() {
  return (
    ...
    <View style={styles.container}>
      <Box style={{ backgroundColor: "silver" /*alignSelf: 'flex-start'*/ }}>
        Box 1
      </Box>
      ...
      <Box style={{ backgroundColor: "orange", flexBasis: 140, flex: 1 /*alignSelf: 'stretch'*/ }}>
        Box 4
      </Box>
      <Box
        style={{
          backgroundColor:
            "blue" /** the default value is the same of the value of alignItems parent property*/,
        }}
      >
        Box 5
      </Box>
